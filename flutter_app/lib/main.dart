...
class SymbaroumCompanionApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Écran de connexion Firebase (home) — the global builder will wrap all routes
      home: const FirebaseLoginScreen(),
      // Wrap all app routes and dialogs with the ResponsiveWrapper so every page
      // remains constrained and centered on wide screens (consistent UX)
